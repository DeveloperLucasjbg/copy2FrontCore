export const environment = {
  ...
  envName: 'prod',
  recaptcha: {
    siteKey: '6LdGZFUaAAAAAKa0qTE3Fa4If4h2hFnZYujG-OyX',
    siteKey2: '6LeftmwcAAAAAHAxIxaDDk4HJ4tUibJ-Y6WxtQPm',
  },
  idleTimeout: 60,
  ...
  /* https://iqa3n4gwe3.execute-api.us-west-2.amazonaws.com/prod/api-onboarding-pandc/canales-onboarding-pandc/ */
  API_URL:
    'https://iqa3n4gwe3.execute-api.us-west-2.amazonaws.com/prod/api-onboarding-pandc/',
  API_PORT: '',
  API_PATH: 'canales-onboarding-pandc/',
  API_VERSION: 'v1',
  gtagCode: 'UA-83050105-10',
  googleTagManagerId: 'GTM-MZ4RDWK',
  urlOnboardingBrasil: 'https://segurogarantiabr.avla.com/',
  ...
  datadogRum: {
    clientToken: 'pub347d1832060bc92fb8098d021dc946df',
    applicationId: 'fbe31c05-dd74-4b17-a6cc-0b199b58c29a',
    // `site` refers to the Datadog site parameter of your organization
    // see https://docs.datadoghq.com/getting_started/site/
    site: 'datadoghq.com',
    service: 'canales-onboarding-pandc-backend',
    env: 'prod',
