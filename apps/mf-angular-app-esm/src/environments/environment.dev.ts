export const environment = {
  ...
  /* https://nqnu43pomh.execute-api.us-west-2.amazonaws.com/dev/api-onboarding-pandc/ */
  API_URL:
    'https://o4jnqsl47e.execute-api.us-west-2.amazonaws.com/dev/api-onboarding-pandc/',
  API_PORT: '',
  API_PATH: 'canales-onboarding-pandc/',
  API_VERSION: 'v1',
  gtagCode: 'UA-83050105-10',
  googleTagManagerId: 'GTM-PXQ4NMT',
